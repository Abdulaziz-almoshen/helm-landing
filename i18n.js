...
;(function () {
  ...
  const translations = {
    en: {
      ...
      'canvas.summary_text': 'Team reviewed Q2 roadmap and approved the <strong>AI chat feature</strong> for Sprint 8. <span class="mention"><span>M</span> Munira</span> leads design sprint starting <strong>Monday</strong>. 2 engineers reallocated to platform. Investor deck update due <strong>March 15</strong>.',
      ...
      'canvas.task_do1': 'Send <span class="mention"><span>M</span> Munira</span> the design brief — sprint starts Monday',
      ...
      'canvas.why_text': "Munira's design sprint starts Monday. Without the brief today, 3 engineers are blocked. Urgency: high. Impact: delays Sprint 8 and Q2 roadmap delivery.",
      'canvas.people_title': 'People Mentioned',
      'canvas.person_ahmed': 'Ahmed — 4 action items',
      'canvas.person_sara': 'Munira — 1 delegated task',
      ...
      'capture.phone_msg3': 'Munira needs the updated timeline by Friday.',
      ...
      'integ.invite_m2': 'Munira updated the Q1 canvas',
    ...
    ar: {
      ...
      'scene.min2': 'منيرة تقود سبرينت التصميم من الاثنين',
      'scene.min3': 'مهندسان أُضيفا لفريق المنصة',
      'scene.tasks': 'المهام المنشأة',
      'scene.task1': 'أرسل لمنيرة موجز التصميم قبل الأربعاء',
      'scene.task2': 'حدّث عرض المستثمرين بخارطة طريق Q2',
      'scene.task3': 'جدوِل جلسة تخطيط السبرينت 8',
      'scene.next': 'الخطوة التالية',
      'scene.next_text': 'أرسل لمنيرة موجز التصميم — السبرينت يبدأ الاثنين، و3 مهندسين في الانتظار',
      ...
      'canvas.summary_text': 'راجع الفريق خارطة طريق Q2 واعتمد <strong>ميزة AI Chat</strong> للسبرينت 8. <span class="mention"><span>م</span> منيرة</span> تقود سبرينت التصميم من <strong>الاثنين</strong>. مهندسان أُعيد توزيعهما على المنصة. تحديث عرض المستثمرين <strong>١٥ مارس</strong>.',
      ...
      'canvas.task_do1': 'أرسل لـ<span class="mention"><span>م</span> منيرة</span> موجز التصميم — السبرينت يبدأ الاثنين',
      ...
      'canvas.person_sara': 'منيرة — مهمة واحدة مفوّضة',
      ...
      'capture.phone_msg3': 'منيرة تحتاج الجدول المحدّث قبل يوم الجمعة.',
      ...
      'integ.invite_m2': 'منيرة حدّثت لوحة الربع الأول',
